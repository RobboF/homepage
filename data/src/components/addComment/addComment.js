...
const AddComment = (props) => {
  ...
  return (
      <div className=" pa4 black-80 flex flex-column center ba mw7-ns">
        ...
        <input id="name" className="input-reset ba b--black-20 pa2 mb2 db w-100" type="text" aria-describedby="name-desc" value={username} onChange={e => setUsername(e.target.value)}/>
        ...
        <textarea id="comment" name="comment" className="db border-box hover-black w-100 ba b--black-20 pa2 mb2" value={comment} aria-describedby="comment-desc" onChange={e => setComment(e.target.value)}></textarea>
